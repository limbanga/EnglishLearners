...
public class MultipleChoiceListVocabulary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adt = new ViewListVocaularyAdapter(this,MultipleChoiceActivity.IncorectWord,textToSpeech);
        adt2 = new ViewListVocaularyAdapter(this,MultipleChoiceActivity.CorectWord,textToSpeech);

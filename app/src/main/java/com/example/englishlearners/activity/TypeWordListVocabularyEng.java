...
public class TypeWordListVocabularyEng extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adt = new ViewListVocaularyAdapter(this,TypeWordEnglish.IncorectWord,textToSpeech);
        adt2 = new ViewListVocaularyAdapter(this,TypeWordEnglish.CorectWord,textToSpeech);
